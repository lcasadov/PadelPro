...
Objetivo: Diseño de arquitectura a alto nivel.Analiza toda la documentación disponible @prompts/descripcion/descripcion.md y @readme.md y, basándote sólo y exclusivamente en esta información, diseña el sistema a un alto nivel, añadiendo además ventajas y desventajas del stack tecnológico seleccionado  y si propondrías otro.

Outputs a generar: actualiza el @readme.md  genera la documentación relativa al punto 3 Arquitectura del sistema  e incluye los  diagramas de arquitectura necesarios en formato Mermaid

Si necesitas solucionar dudas, pregúntame antes de realizar nada.
