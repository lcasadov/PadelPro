...
When critical or medium issues are found, create a Bug Issue vía el CLI `gh` (autenticado como `orquestadoria`). Read `GITHUB_ORG`, `GITHUB_REPO` from `docs/PROJECT.md`.
